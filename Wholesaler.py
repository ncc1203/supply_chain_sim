...
class Wholesaler:
    ...
    ## Initialization
    def __init__(self, hospitals, name, suppliers, customers, ss, l, order_policy_function, allocation_policy_function):
        ...
        self.customer_demand_mean = sum([hospitals[i].customer_demand_mean for i in customers])
    ...
    def receive_order(self, hospital_order, hospital_id):
        customer_idx = self.customers.index(hospital_id)
        self.customers_orders[customer_idx] = hospital_order
    ...
    def determine_orders(self, all_manufacturers):
        return self.order_policy(self, all_manufacturers)