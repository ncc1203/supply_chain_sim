...
class Manufacturer:
    ...
    ## Initialization
    def __init__(self, wholesalers, name, ss, m, l, pl, customers, production_policy_function, allocation_policy_function):
        ...
        self.customer_demand = sum([wholesalers[i].customer_demand_mean for i in customers])
    ...
    def receive_order(self, wholesaler_order, wholesaler_id):
        customer_idx = self.customers.index(wholesaler_id)
        self.customers_orders[customer_idx] = wholesaler_order
